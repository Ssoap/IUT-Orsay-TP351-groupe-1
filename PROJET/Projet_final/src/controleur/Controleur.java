...
public class Controleur {
	...
	private void tic(){
		...
		vue.majPvJoueur(modele.getPvJoueur());
		if(modele.getPvJoueur() <= 0){
			String[] choix = {"Recommencer", "Quitter"} ;
			 int reponse = JOptionPane.showOptionDialog(null, "Voulez-vous recommencer ?", "Fin de partie", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, choix, choix[0]);
			 if(reponse == 0){
				nouvellePartie() ;
				return ;
			 }
